...
export default class CreateChecklistThroughTemplatePage extends React.Component {
    constructor(props) {
        super(props);
    ...
    render(props) {
        if (this.state.toCreateAndRedirect) {
            ...
            const url = `http://35.189.65.78/api/template/${id}/createChecklist`
            const header = {
                method: 'POST',
                headers: {
            ...
            <div>
                <div>
                    <div className="container panel panel-default" id="login-box">
                        <h1 className="text-center">Create Checklist Through This Template</h1>
